...
<head>
    <?php load_template('template','head'); ?>
</head>
        ...
        <div class="container-xxl position-relative p-0" id="home">
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                <a href="" class="navbar-brand p-0">
                    <!-- <h1 class="m-0">GoWorkbase</h1> -->
                    <img src="img/goworkbase-logo.png" alt="Logo">
                </a>
                ...
                <div class="container">
                    <div class="row g-5 align-items-center">
                        <div class="col-lg-6 text-center text-lg-start">
                            ...
                            <p class="text-white pb-3 animated slideInDown">Effortlessly manage employees, track attendance, process payroll, and monitor performance — all in one powerful platform. Designed for businesses of all sizes to simplify HR and operational workflows.</p>
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            &copy; <a class="border-bottom" href="https://workbase.gocosys.com">GoWorkbase</a>, All Right Reserved. 
							
							<!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
							Developed By <a class="border-bottom" href="https://www.suriyaravichandran.me">Suriya Ravichandran</a>
                            <br>Distributed By: <a class="border-bottom" href="https://gocosys.com" target="_blank">GOCOSYS PVT LTD</a>
                        </div>
